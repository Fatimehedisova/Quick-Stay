...
const FeaturedDestination = () => {
    ...
    return (
        <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20'>
            ...
            <Title title='Fetured Destination' subTitle='Discover our handpicked seection of exceptional properties around the world, offering unparelleled luxury and unforgettable experiences.' />
