...
const Testimonial = () => {
        ...
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-96 shrink-0">
    ...
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 pt-20 pb-30'>
        <Title title="What Our Guests Say" subTitle="Discover why discerning travelers consistently choose SupeRoom for their exclusive and lucurious accommodations around the world." />
